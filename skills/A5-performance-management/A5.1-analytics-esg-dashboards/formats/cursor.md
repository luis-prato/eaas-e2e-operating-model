---
description: "A5.1 Analytics & ESG Dashboards — Design and deploy the three-tier dashboard architecture that gives operations, customers, and leader..."
globs: ["**/*.ts", "**/*.py", "**/*.js", "**/*.md"]
alwaysApply: false
---

# A5.1 — Analytics & ESG Dashboards ★ NEW v1.24
