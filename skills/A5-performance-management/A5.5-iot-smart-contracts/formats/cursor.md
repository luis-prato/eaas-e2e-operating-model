---
description: "A5.5 IoT & Smart Contracts — Integrate real-time asset telemetry with automated contract execution — so performance data triggers..."
globs: ["**/*.ts", "**/*.py", "**/*.js", "**/*.md"]
alwaysApply: false
---

# A5.5 — IoT & Smart Contracts ★ NEW v1.24
